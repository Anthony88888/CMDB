...
#             self._delete_original_asset()  # 从待审批区删除已审批上线的资产
...
#                     'net_mask': net_mask,
#                 }
#                 models.NIC.objects.update_or_create(asset=self.asset, models=new_nics_dict[key]['model'],
